...
class PhaseDataset_M2CAI(Dataset):
    """Load video phase recognition dataset."""

    def __init__(
        self,
        anno_path="data/M2CAI/labels/train/1fpstrain.pickle",
...
def build_dataset(is_train, test_mode, fps, args):
    ...
    print("%s %s - %s : Number of the class = %d" % ("M2CAI", mode, fps, args.nb_classes))
